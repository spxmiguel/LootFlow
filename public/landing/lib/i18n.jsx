...
const dict = {
  pt: {
    ...
    "features.2.body": "O bot te cutuca toda semana, nos dias que você configurar. Responde com o nome do item — ele busca o preço no Steam sozinho. Quer modo xingamentos? Funciona melhor.",
    ...
    "features.viz.wa.bot": "Faltam 2 contas pra registrar essa semana 👀",
    "features.viz.wa.me": "DROP AKM Karambit Fade",
    "features.viz.wa.bot2": "🔍 R$ 178,40 · confirmar?",
    ...
    "how.title": "Três passos. Sem fricção.",
    "how.passo": "passo",
    ...
    "how.2.body": "Marca os drops na dashboard ou responde o bot no WhatsApp com o valor. Leva 10 segundos por conta.",
    ...
    "wa.body": "Toda semana, nos dias que você definir, o bot manda lembrete pelas contas que faltam. Responde o nome do item — ele busca o preço no Steam e registra com um SIM. Sem app pra abrir, sem login. Quer mais agressivo? Tem modo xingamentos.",
    ...
    "wa.mock.1": "Ei 👋 Semana 22. Faltam 2 contas pra registrar drop:\n• knife_hunter — 0/2\n• skin_collector — 0/2",
    "wa.mock.2": "Responde DROP [conta] [item] pra registrar, ou /help pra ver os comandos.",
    "wa.mock.3": "DROP knife_hunter Karambit Fade",
    "wa.mock.4": "🔍 *Confirmar drop?*\n• Conta: knife_hunter\n• Item: ★ Karambit | Fade\n• Steam: R$ 178,40\n\nResponda SIM ou NÃO.",
    "wa.mock.5": "SIM",
    "wa.mock.6": "✅ Drop registrado! knife_hunter · drop 1\nR$ 178,40 · est. cashout R$ 151,64 💪",
  ...
  en: {
    ...
    "features.2.body": "The bot nudges you every week, on the days you configure. Reply with the item name — it fetches the Steam price automatically. Want roast mode? It works better.",
    ...
    "features.viz.chart.delta": "+R$ 80",
    "features.viz.wa.bot": "2 accounts left to log this week 👀",
    "features.viz.wa.me": "DROP AKM Karambit Fade",
    "features.viz.wa.bot2": "🔍 R$ 178.40 · confirm?",
    ...
    "how.2.body": "Mark drops on the dashboard or reply to the bot on WhatsApp with the value. Takes 10 seconds per account.",
    ...
    "wa.body": "Every week, on the days you pick, the bot pings you about pending accounts. Reply with the item name — it fetches the Steam price and registers with a YES. No app to open, no login. Want it more aggressive? Roast mode is built in.",
    ...
    "wa.mock.1": "Hey 👋 Week 22. 2 accounts still need drops:\n• knife_hunter — 0/2\n• skin_collector — 0/2",
    "wa.mock.2": "Reply DROP [account] [item] to log, or /help for commands.",
    "wa.mock.3": "DROP knife_hunter Karambit Fade",
    "wa.mock.4": "🔍 *Confirm drop?*\n• Account: knife_hunter\n• Item: ★ Karambit | Fade\n• Steam: R$ 178.40\n\nReply YES or NO.",
    "wa.mock.5": "YES",
    "wa.mock.6": "✅ Drop logged! knife_hunter · drop 1\nR$ 178.40 · est. cashout R$ 151.64 💪",
